...
CREATE OR REPLACE FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" integer, "p_direction" integer) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" integer, "p_direction" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" numeric, "p_direction" integer) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF p_menu_item_id IS NULL OR COALESCE(p_quantity, 0) <= 0 THEN
...
ALTER FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" numeric, "p_direction" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."sync_gasto_inventory_stock"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."sync_gasto_inventory_stock"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_gasto_item_inventory_stock"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF TG_OP = 'INSERT' THEN
...
ALTER FUNCTION "public"."sync_gasto_item_inventory_stock"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."caja_movimientos" (
    ...
    CONSTRAINT "caja_movimientos_metodopago_check" CHECK (("metodopago" = ANY (ARRAY['efectivo'::"text", 'tarjeta'::"text", 'nequi'::"text", 'provision_caja'::"text"]))),
...
CREATE OR REPLACE VIEW "public"."balance_caja" AS
 WITH "resumen" AS (
         SELECT "caja_movimientos"."fecha",
            ...
            "sum"(
                CASE
                    WHEN (("caja_movimientos"."tipo" = 'INGRESO'::"text") AND ("caja_movimientos"."metodopago" = 'provision_caja'::"text")) THEN "caja_movimientos"."monto"
                    ELSE (0)::numeric
                END) AS "ingresos_provision_caja",
            "sum"(
                CASE
                    WHEN (("caja_movimientos"."tipo" = 'EGRESO'::"text") AND ("caja_movimientos"."metodopago" = 'provision_caja'::"text")) THEN "caja_movimientos"."monto"
                    ELSE (0)::numeric
...
CREATE TABLE IF NOT EXISTS "public"."gasto_inventario_items" (
    ...
    CONSTRAINT "gasto_inventario_items_cantidad_check" CHECK (("cantidad" > (0)::numeric)),
    CONSTRAINT "gasto_inventario_items_inventario_tipo_check" CHECK ((("inventario_tipo" IS NULL) OR ("inventario_tipo" = ANY (ARRAY['cantidad'::"text", 'peso'::"text", 'volumen'::"text"]))))
);


ALTER TABLE "public"."gasto_inventario_items" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gastos" (
    ...
    "metodopago" "text" DEFAULT 'efectivo'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "es_inventariable" boolean DEFAULT false NOT NULL,
    "menu_item_id" "uuid",
    "cantidad_inventario" numeric(12,3),
    "inventario_tipo" "text",
    "unidad_inventario" "text",
    "lugar_compra" "text",
    CONSTRAINT "gastos_inventariable_payload_check" CHECK (((("es_inventariable" = false) AND ("menu_item_id" IS NULL) AND ("cantidad_inventario" IS NULL)) OR (("es_inventariable" = true) AND ((("menu_item_id" IS NOT NULL) AND ("cantidad_inventario" IS NOT NULL) AND ("cantidad_inventario" > (0)::numeric)) OR (("menu_item_id" IS NULL) AND ("cantidad_inventario" IS NULL)))))),
    CONSTRAINT "gastos_inventario_tipo_check" CHECK ((("inventario_tipo" IS NULL) OR ("inventario_tipo" = ANY (ARRAY['cantidad'::"text", 'peso'::"text", 'volumen'::"text"])))),
    CONSTRAINT "gastos_metodopago_check" CHECK (("metodopago" = ANY (ARRAY['efectivo'::"text", 'tarjeta'::"text", 'nequi'::"text", 'provision_caja'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."inventario_compra_historial" (
    ...
    "lugar_compra" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "inventario_compra_historial_cantidad_check" CHECK (("cantidad" > (0)::numeric)),
    CONSTRAINT "inventario_compra_historial_precio_total_check" CHECK (("precio_total" >= (0)::numeric)),
    CONSTRAINT "inventario_compra_historial_precio_unitario_check" CHECK (("precio_unitario" > (0)::numeric)),
    CONSTRAINT "inventario_compra_historial_unidad_tipo_check" CHECK (("unidad_tipo" = ANY (ARRAY['cantidad'::"text", 'peso'::"text"])))
);


ALTER TABLE "public"."inventario_compra_historial" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "metodo_pago" "text",
    CONSTRAINT "orders_metodo_pago_check" CHECK ((("metodo_pago" IS NULL) OR ("metodo_pago" = ANY (ARRAY['efectivo'::"text", 'tarjeta'::"text", 'nequi'::"text", 'provision_caja'::"text", 'credito_empleados'::"text"]))))
);
...
ALTER TABLE ONLY "public"."gasto_inventario_items"
    ADD CONSTRAINT "gasto_inventario_items_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."inventario_compra_historial"
    ADD CONSTRAINT "inventario_compra_historial_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_employee_credit_history_order_id" ON "public"."employee_credit_history" USING "btree" ("order_id");



CREATE INDEX "idx_employee_credit_history_order_numero" ON "public"."employee_credit_history" USING "btree" ("order_numero");



CREATE INDEX "idx_gasto_inventario_items_gasto_id" ON "public"."gasto_inventario_items" USING "btree" ("gasto_id");



CREATE INDEX "idx_gasto_inventario_items_menu_item_id" ON "public"."gasto_inventario_items" USING "btree" ("menu_item_id");



CREATE INDEX "idx_inventario_compra_historial_created_at" ON "public"."inventario_compra_historial" USING "btree" ("created_at" DESC);



CREATE INDEX "idx_inventario_compra_historial_menu_item" ON "public"."inventario_compra_historial" USING "btree" ("menu_item_id");
...
CREATE OR REPLACE TRIGGER "trg_gasto_items_inventory_stock" AFTER INSERT OR DELETE OR UPDATE ON "public"."gasto_inventario_items" FOR EACH ROW EXECUTE FUNCTION "public"."sync_gasto_item_inventory_stock"();
...
CREATE OR REPLACE TRIGGER "trg_gastos_inventory_stock" AFTER INSERT OR DELETE OR UPDATE ON "public"."gastos" FOR EACH ROW EXECUTE FUNCTION "public"."sync_gasto_inventory_stock"();
...
ALTER TABLE ONLY "public"."gasto_inventario_items"
    ADD CONSTRAINT "gasto_inventario_items_gasto_id_fkey" FOREIGN KEY ("gasto_id") REFERENCES "public"."gastos"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gasto_inventario_items"
    ADD CONSTRAINT "gasto_inventario_items_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id");



ALTER TABLE ONLY "public"."gastos"
    ADD CONSTRAINT "gastos_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."inventario_compra_historial"
    ADD CONSTRAINT "inventario_compra_historial_gasto_id_fkey" FOREIGN KEY ("gasto_id") REFERENCES "public"."gastos"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."inventario_compra_historial"
    ADD CONSTRAINT "inventario_compra_historial_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menu_items"("id") ON DELETE CASCADE;
...
CREATE POLICY "public_all_inventario_compra_historial" ON "public"."inventario_compra_historial" USING (true) WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" integer, "p_direction" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" integer, "p_direction" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" integer, "p_direction" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" numeric, "p_direction" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" numeric, "p_direction" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."apply_gasto_inventory_delta"("p_menu_item_id" "uuid", "p_quantity" numeric, "p_direction" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_gasto_inventory_stock"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_gasto_inventory_stock"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_gasto_inventory_stock"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_gasto_item_inventory_stock"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_gasto_item_inventory_stock"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_gasto_item_inventory_stock"() TO "service_role";
...
GRANT ALL ON TABLE "public"."gasto_inventario_items" TO "anon";
GRANT ALL ON TABLE "public"."gasto_inventario_items" TO "authenticated";
GRANT ALL ON TABLE "public"."gasto_inventario_items" TO "service_role";
